...
routerAR.get("/", authorize, arbitre.getAll)
routerAR.get("/:id", authorize, arbitre.getByID)
routerAR.post("/", validationarbite, authenticate, authorize("commissaire", "admin"), arbitre.setData)
routerAR.put("/:id", validationarbite, authorize , authorize("commissaire", "admin"), arbitre.updateData)
